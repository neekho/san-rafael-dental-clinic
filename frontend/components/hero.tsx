      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center px-4">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-balance">
            Mandaluyong's Premier <span className="text-primary">Dental Clinic</span> in Plainview
          </h1>
          <p className="text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto text-balance">
            At San Rafael Dental Clinic in Mandaluyong City, we provide expert dental care to families in Plainview, Shaw Boulevard, and surrounding Metro Manila communities since 1999.
          </p>
